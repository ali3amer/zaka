                                                        ...
                                                        @foreach($category->products as $product)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    class="btn btn-success btn-sm add-product-btn"><i class="fa fa-plus"></i></a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </table>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form action="{{ route('dashboard.clients.orders.store',$client->id) }}" method="post">
                                ...
                                <button type="submit" class="btn btn-primary btn-block disabled" id="add-order-form-btn"><i class="fa fa-plus"></i> @lang('site.add_order')</button>
